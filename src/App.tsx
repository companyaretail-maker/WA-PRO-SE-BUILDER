...
import { 
  ...
  DayCountCalculator, FacilitatorDirectory, SummonsEngine, HearingEngine,
  ...
  return (
    <div className="h-screen bg-bg text-ink flex flex-col lg:grid lg:grid-cols-[280px_1fr_300px] lg:grid-rows-[auto_1fr_auto] font-sans overflow-hidden">
      ...
      <aside className="hidden lg:flex flex-col border-l border-ink-faint p-6 bg-[#09090b] overflow-y-auto">
        ...
        <div className="bg-[#111] p-4 border border-ink-faint mb-4">
          ...
          <div className="flex items-center justify-between border border-ink-faint bg-black p-1 pl-3">
            <span className="text-[11px] font-mono text-white truncate max-w-[140px]">{selectedCounty.toUpperCase()}</span>
            <button
        ...
        <div className="bg-[#111] p-4 border border-ink-faint mb-4">
          ...
          <p className="text-[11px] text-ink-muted leading-relaxed">
            Documents generated in this environment are formatted for Washington State General Rule 14 standards (12pt font, 1.5 line spacing, 3-inch top margin on first page).
          </p>
        </div>
        
        <div className="bg-accent/5 p-4 border border-accent/20 mt-auto">
          <h4 className="font-mono text-[11px] text-accent mb-3 text-center">UNLOCK FULL PACKET</h4>
          <button 
      ...
      <TermsModal 
        ...
        onAccept={handlePurchaseComplete}
      />
      <LegalPoliciesModal 
